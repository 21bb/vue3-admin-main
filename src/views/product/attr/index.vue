  ...
  <div>
    ...
    <el-card style="margin:10px 0px">
      ...
      <div v-show="scene == 1">
          ...
          <el-table-column label="属性值名称">
            <template #="{ row, $index }">
              <el-input :ref="(vc: any) => inputArr[$index] = vc" v-if="row.flag" @blur="toLook(row, $index)"
                size="small" placeholder="请您输入属性值名称" v-model="row.valueName">
              </el-input>
        ...
        <el-button type="primary" :disabled="attrParams.attrValueList.length > 0 ? false : true" size="default"
          icon="Plus" @click="save">保存</el-button>
        <el-button type="primary" size="default" @click="cancel">取消</el-button>
      </div>
    </el-card>
  </div>
...
const getAttr = async () => {
  ...
  if (result.code == 200) {
    // 如果后端没数据，我们就造点假数据进去测试
    if (!result.data || result.data.length === 0) {
      attrArr.value = [
        {
          id: 1,
          attrName: '价格',
          categoryId: c3Id as number,
          categoryLevel: 3,
          attrValueList: [
            { id: 101, valueName: '1000-2000', attrId: 1 },
            { id: 102, valueName: '2000-3000', attrId: 1 },
          ],
        },
        {
          id: 2,
          ...
          categoryLevel: 3,
          attrValueList: [
            { id: 201, valueName: '红色', attrId: 2 },
            { id: 202, valueName: '蓝色', attrId: 2 },
            { id: 203, valueName: '黑色', attrId: 2 },
          ],
        },
        {
          id: 3,
          ...
          categoryLevel: 3,
          attrValueList: [
            { id: 301, valueName: '8G', attrId: 3 },
            { id: 302, valueName: '16G', attrId: 3 },
            { id: 303, valueName: '32G', attrId: 3 },
          ],
        },
      ]
    } else {
